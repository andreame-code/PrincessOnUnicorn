...
let obstacles = [];
let score = 0;
// speed and physics tuned for very young children
let speed = 3;
let gravity = 0.5;
let gameOver = false;
...
function update() {
  ...
  // generate obstacles less frequently and make them smaller
  if (Math.random() < 0.01) {
    obstacles.push({x: canvas.width, width: 20, height: 30});
  }
